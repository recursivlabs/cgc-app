...
> **Note:** this is the minimal **deploy starter** (Nixpacks defaults, no SDK).
> For the full Recursiv SDK starter (auth, database, storage, agents wired), use
> `templates/nextjs/` — that's also what `create-recursiv-app` scaffolds.
