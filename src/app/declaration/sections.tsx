...
/**
 * The declaration itself: the quote, the values, and the sign form. Shared by
 * the declaration page and by every shared-signature page, so a shared link
 * lands people on the same reading and the same form.
 */
...
export function DeclarationQuote() {
  return (
